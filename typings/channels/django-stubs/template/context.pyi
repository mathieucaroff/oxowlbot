...
class BaseContext(Iterable[Any]):
    ...
    def setdefault(self, key: Union[IfChangedNode, str], default: Optional[Union[List[Origin], int]] = ...) -> Optional[Union[List[Origin], int]]:
        ...
...
class RequestContext(Context):
    ...
    use_l10n: None
    use_tz: None
    def __init__(self, request: HttpRequest, dict_: Optional[Dict[str, Any]] = ..., processors: Optional[List[Callable]] = ..., use_l10n: None = ..., use_tz: None = ..., autoescape: bool = ...) -> None:
        ...
