...
class Origin:
    def __init__(self, name: str, template_name: Optional[Union[bytes, str]] = ..., loader: Optional[Loader] = ...) -> None:
        ...
...
class Template:
    def __init__(self, template_string: Union[Template, str], origin: Optional[Origin] = ..., name: Optional[str] = ..., engine: Optional[Engine] = ...) -> None:
        ...
    
    def __iter__(self) -> None:
        ...
    
    def render(self, context: Optional[Union[Context, Dict[str, Any]]] = ..., request: Optional[HttpRequest] = ...) -> Any:
        ...
...
class Parser:
    def __init__(self, tokens: Union[List[Token], str], libraries: Optional[Dict[str, Library]] = ..., builtins: Optional[List[Library]] = ..., origin: Optional[Origin] = ...) -> None:
        ...
