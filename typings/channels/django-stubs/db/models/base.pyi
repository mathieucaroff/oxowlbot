...
from typing import Any, Callable, Collection, Dict, List, Optional, Sequence, Set, Tuple, Type, TypeVar, Union
...
class Model(metaclass=ModelBase):
    ...
    def save(self, force_insert: bool = ..., force_update: bool = ..., using: Optional[str] = ..., update_fields: Optional[Union[Sequence[str], str]] = ...) -> None:
        ...
    
    def save_base(self, raw: bool = ..., force_insert: bool = ..., force_update: bool = ..., using: Optional[str] = ..., update_fields: Optional[Union[Sequence[str], str]] = ...):
        ...
