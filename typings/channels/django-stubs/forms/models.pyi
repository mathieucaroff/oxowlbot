...
from typing import Any, Callable, Container, Dict, Iterator, List, Mapping, MutableMapping, Optional, Sequence, Tuple, Type, TypeVar, Union
...
def _get_foreign_key(parent_model: Type[Model], model: Type[Model], fk_name: Optional[str] = ..., can_fail: bool = ...) -> ForeignKey:
    ...
